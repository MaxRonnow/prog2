...
/**
 * This is the abstract class Vehicle which you will extend to implement the vehicles.
 * Look at the VehicleSpecifications.md and implement the vehicles according to the specifications.
 *
 * As the class parameters below indicate, each vehicle tracks the distance traveled, the current road and the fuel.
 * Take some time to familiarize yourself with this class, but
 * DO NOT EDIT THIS FILE
 */

public abstract class Vehicle {
    private int totalDistanceTravelled; // distance total
    private int roadDistanceTravelled; // distance on the current road
    private Road currentRoad;  // reference to the current road
    private int fuelLeft;
    private boolean isRefueling;
    private int currentSpeed;
    private final String name;  // only used when printing
    private int doneInTurns; // will be set once the vehicle has finished
    private Color color;  // for displaying in Main
    ...
    public void nextRoad(){
        // Roads are linked lists, so get the next road, reset road distance traveled
    ...
    private void addDistance(final int distance){
        // add to both total and current road distance
